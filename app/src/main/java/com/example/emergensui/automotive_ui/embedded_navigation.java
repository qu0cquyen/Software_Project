...
import com.example.emergensui.automotive_ui.Class.Ambulance;
...
public class embedded_navigation extends AppCompatActivity implements OnNavigationReadyCallback,
    ...
    private void initialization() {
        ...
        heartBeat = findViewById(R.id.txtHeartBeat);
        txtSpeed = findViewById(R.id.txtSpeed);

        Bundle b = getIntent().getExtras();
        ORIGIN = (Point) b.getSerializable("Original Point");
        DESTINATION = (Point) b.getSerializable("Destination Point");
    }
    ...
    private void databaseQuery()
    {
        ...
        String path = "Ambulance/";
        mReference = mDatabase.getReference(path);

        mReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Ambulance a = dataSnapshot.getValue(Ambulance.class);

                heartBeat.setText(a.getHeart_rate());
                txtSpeed.setText(a.getVehicle_speed());
